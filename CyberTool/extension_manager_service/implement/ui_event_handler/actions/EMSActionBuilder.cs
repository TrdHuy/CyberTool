        ...
        public override IViewModelCommandExecuter? BuildViewModelCommandExecuter(string keyTag, object? dataTransfer, BaseViewModel viewModel, ILogger? logger = null)
        {
            ...
            switch (keyTag)
            {
                case ExtensionManagerKeyFeatureTag.KEY_TAG_EMS_INSTALL_PLUGIN_FEATURE:
                    viewModelCommandExecuter = new EMS_PI_InstallPluginButtonAction(keyTag, ExtensionManagerDefinition.SERVICE_TAG, dataTransfer, viewModel, logger);
                    break;
                case ExtensionManagerKeyFeatureTag.KEY_TAG_EMS_UNINSTALL_PLUGIN_FEATURE:
                    viewModelCommandExecuter = new EMS_PI_UninstallPluginButtonAction(keyTag, ExtensionManagerDefinition.SERVICE_TAG, dataTransfer, viewModel, logger);
                    break;
                default:
                    break;
            }
