...
namespace extension_manager_service.view_models.commands.plugin_item
{
    ...
    {
        public CommandExecuterImpl InstallButtonCommand { get; set; }
        public CommandExecuterImpl UninstallButtonCommand { get; set; }
        ...
        {
            InstallButtonCommand = new CommandExecuterImpl((paramaters) =>
            {
                return OnKey(ExtensionManagerKeyFeatureTag.KEY_TAG_EMS_INSTALL_PLUGIN_FEATURE
                    , paramaters);
            });
            UninstallButtonCommand = new CommandExecuterImpl((paramaters) =>
            {
