...
namespace progtroll.implement.ui_event_handler.actions.project_manager.gesture
{
    ...
    {
        public PRT_PM_VersionFilePathSelectedAction(string actionID, string builderID, BaseViewModel viewModel, ILogger? logger)
        ...
        protected override void ExecuteCommand()
        {
            if (DataTransfer != null)
            {
                ...
                var message = HoneyboardReleaseService.Current.ServiceManager?.App.OpenMultiTaskBox("Parsing version properties file", multiTask);
