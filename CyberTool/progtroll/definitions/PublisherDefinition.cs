...
namespace progtroll.definitions
{
    internal class PublisherDefinition
    {
        public const string SERVICE_PAGE_URI_ORIGINAL_STRING = "pack://application:,,,/progtroll;component/views/usercontrols/ServiceView.xaml";
    ...
    internal class PublisherKeyFeatureTag
    {
        ...
        public const string KEY_TAG_PRT_PUSH_RELEASE_COMMIT_FEATURE = "KEY_TAG_PRT_PUSH_RELEASE_COMMIT_FEATURE";
        ...
        public const string KEY_TAG_PRT_PM_VERSION_FILE_PATH_SELECTED_FEATUER = "KEY_TAG_PRT_PM_VERSION_FILE_PATH_SELECTED_FEATUER";
