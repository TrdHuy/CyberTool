...
{
    public class DashboardService : ICyberService
    {
        public string ServiceID { get; private set; }

        public long ServicePageLoadingDelayTime { get; private set; }

        public string HeaderGeometryData { get; private set; }

        public string Header { get; private set; }

        public bool IsUnderconstruction => true;

        public ICyberServiceManager ServiceManager { get; private set; }

        public Uri ServiceResourceUri => throw new NotImplementedException();
        ...
        public void OnServiceCreate(ICyberServiceManager cyberServiceManager)
        {
        }

        public void OnPreServiceViewInit(ICyberServiceManager cyberServiceManager)
        {
        }

        public void OnServiceViewInstantiated(ICyberServiceManager cyberServiceManager)
        {
        }

        public void OnServiceUnloaded(ICyberServiceManager cyberServiceManager)
        {
        }
